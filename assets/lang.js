...
,["Clubs","UIUC Photography","Photon Pictures","Jasmine Field","Imaginasian Dance Crew"],
...
function getEN() {
    ...
    document.getElementById("tab_jf").innerHTML = tab_en[2][3][1];
    document.getElementById("tab_pp").innerHTML = tab_en[2][3][2];
    document.getElementById("tab_dance").innerHTML = tab_en[3][2][3];
    document.getElementById("tab_pho").innerHTML = tab_en[2][3][4];
